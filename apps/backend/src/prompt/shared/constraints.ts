...
- After calling a tool, say nothing about it. Continue the conversation naturally. The tool result is handled silently — you never need to announce or describe tool execution.`;
}
